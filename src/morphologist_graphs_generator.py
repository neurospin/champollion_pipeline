...
def run_morpho_graphs(input_path: str, output_path="./derivatives/"):
    ...
    if not exists(output_path):
        ...
        # print(f"morphologist_graphs_generator/run_morpho_graphs/list of files in string: {' '.join(input_files)}")
